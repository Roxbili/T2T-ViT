...
parser.add_argument('--model', default='T2t_vit_14', type=str, metavar='MODEL',
                    help='Name of model to train (default: "T2t_vit_14"')
...
parser.add_argument('--num-classes', type=int, default=1000, metavar='N',
                    help='number of label classes (Model default if None, default: 1000)')
...
def main():
    ...
    data_config = resolve_data_config(vars(args), model=model, verbose=args.local_rank == 0)    # 处理输入数据的配置，包括img_size
    ...
    if args.eval_checkpoint:  # evaluate the model
        ...
        _logger.info(f"Top-1 accuracy of the model is: {val_metrics['top1']:.1f}%")
        return
