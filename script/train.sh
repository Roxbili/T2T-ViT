...
# python ${SCRIPT_NAME} /home/fanding/dataset/ILSVRC2012 --model search_model -b 1024 --lr 1e-3 --weight-decay .03 --epochs 300 --workers 4 --pin-mem --search --no-prefetcher

## act
# python ${SCRIPT_NAME} /home/LAB/leifd/dataset/ILSVRC2012 --model t2t_vit_t_1 -b 128 --lr 1e-3 --weight-decay .03 --img-size 224
python ${SCRIPT_NAME} /home/LAB/leifd/dataset/ILSVRC2012 --model search_model -b 4096 --lr 1e-3 --weight-decay .03 --epochs 300 --workers 4 --pin-mem --search --no-prefetcher
