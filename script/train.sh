...
# python main.py /home/fanding/dataset/ILSVRC2012 --model search_model -b 512 --lr 1e-3 --weight-decay .03 --epochs 100 --workers 2 --pin-mem --search
# python main.py /home/LAB/leifd/dataset/ILSVRC2012 --model t2t_vit_t_1 -b 128 --lr 1e-3 --weight-decay .03 --img-size 224
# python main.py /home/LAB/leifd/dataset/ILSVRC2012 --model search_model -b 1536 --lr 1e-3 --weight-decay .03 --epochs 100 --workers 2 --pin-mem --search
